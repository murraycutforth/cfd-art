...
void Euler :: set_boundary_conditions (gridtype& grid, const sim_info& params)
{
...
void Euler :: pre_sweep (gridtype& grid, const sim_info& params)
{
	set_boundary_conditions(grid, params);
}
	
void Euler :: post_sweep (gridtype& grid, gridtype& future_grid, const sim_info& params)
{	
